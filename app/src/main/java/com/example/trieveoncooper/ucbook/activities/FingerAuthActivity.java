...
public class FingerAuthActivity extends AppCompatActivity implements FingerPrintAuthCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finger_auth);
          ...
          mGoToSettingsBtn = (Button) findViewById(R.id.settingsButton);
          mGoToSettingsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FingerPrintUtils.openSecuritySettings(FingerAuthActivity.this);
            }
        });
        ...
        pinEt.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.toString().equals("1234")){
                    Toast.makeText(FingerAuthActivity.this, "Authentication succeeded.", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(FingerAuthActivity.this, Login.class));
                }
            }
